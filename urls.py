...
urlpatterns = patterns('',
    ...
    url(r'^volume$', 'brain.website.views.volume', name='volume'),
    url(r'^volume_down$', 'brain.website.views.volume_down', name='volume_down'),
    url(r'^volume_up$', 'brain.website.views.volume_up', name='volume_up'),
    url(r'^power_off_code/(?P<num>[0-9])$', 'brain.website.views.power_off_code', name='power_off_code'),
    url(r'^power_off_code/Off$', 'brain.website.views.power_off', name='power_off'),
