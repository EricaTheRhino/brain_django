...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RhinoScript'
        db.create_table('processor_rhinoscript', (
        ...
        db.send_create_signal('processor', ['RhinoScript'])


    def backwards(self, orm):
        # Deleting model 'RhinoScript'
        db.delete_table('processor_rhinoscript')
