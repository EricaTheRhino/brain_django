...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tweet'
        db.create_table('processor_tweet', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('processor', ['Tweet'])


        # Changing field 'Component.name'
        db.alter_column('processor_component', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16))

    def backwards(self, orm):
        # Deleting model 'Tweet'
        db.delete_table('processor_tweet')


        # Changing field 'Component.name'
        db.alter_column('processor_component', 'name', self.gf('django.db.models.fields.CharField')(max_length=80, unique=True))
    ...
    models = {
        ...
        'processor.rhinoscript': {
            'Meta': {'object_name': 'RhinoScript'},
